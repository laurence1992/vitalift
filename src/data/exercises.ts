...
export const workoutDays: WorkoutDay[] = [
  {
    ...
    exercises: [
      ...
      { ...e("lat-pulldown"), targetSets: 3, targetReps: "8–12" },
      { ...e("seated-row"), targetSets: 3, targetReps: "8–12" },
      { ...e("db-shoulder-press"), targetSets: 3, targetReps: "8–10" },
      { ...e("lateral-raises"), targetSets: 2, targetReps: "12–15", notes: "Finisher" },
      { ...e("triceps-pushdown"), targetSets: 2, targetReps: "10–12", notes: "Finisher" },
      { ...e("biceps-curls"), targetSets: 2, targetReps: "10–12", notes: "Finisher" },
  ...
  },
  {
    ...
    subtitle: "Lower",
    exercises: [
      { ...e("leg-press"), targetSets: 4, targetReps: "8–12" },
  ...
  },
  {
    ...
    exercises: [
      { ...e("db-incline-press"), targetSets: 3, targetReps: "8–12" },
      { ...e("lat-pulldown"), targetSets: 3, targetReps: "8–12" },
      { ...e("seated-row"), targetSets: 3, targetReps: "8–12" },
      { ...e("db-shoulder-press"), targetSets: 3, targetReps: "10–12" },
      { ...e("lateral-raises"), targetSets: 2, targetReps: "12–15", notes: "Finisher" },
      { ...e("triceps-pushdown"), targetSets: 2, targetReps: "12–15", notes: "Finisher" },
      { ...e("biceps-curls"), targetSets: 2, targetReps: "12–15", notes: "Finisher" },
      { id: "core", name: "Core", image: coreExercise, videoUrl: "", targetSets: 3, targetReps: "12–20 or 30–45s" },
    ],
  },
  {
