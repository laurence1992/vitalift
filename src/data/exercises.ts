...
export const workoutDays: WorkoutDay[] = [
  {
    ...
    exercises: [
      ...
      { ...e("triceps-pushdown"), targetSets: 2, targetReps: "12", notes: "Finisher" },
      { ...e("biceps-curls"), targetSets: 2, targetReps: "12", notes: "Finisher" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { ...e("lateral-raises"), targetSets: 2, targetReps: "15", notes: "Finisher" },
      { ...e("triceps-pushdown"), targetSets: 2, targetReps: "12", notes: "Finisher" },
      { ...e("biceps-curls"), targetSets: 2, targetReps: "12", notes: "Finisher" },
      { id: "core", name: "Core", image: coreExercise, videoUrl: "", targetSets: 3, targetReps: "—" },
    ],
